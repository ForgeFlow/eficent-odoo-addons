...
class TestStock(TransactionCase):
    ...
    def setUp(self):
        ...
        self.move1 = self.create_move(
            'out_aa', self.location1, self.location4
        )
        self.move2 = self.create_move(
            'out', self.location3, self.location4
        )
        self.move3 = self.create_move(
            'in_aa', self.location4, self.location1
        )
