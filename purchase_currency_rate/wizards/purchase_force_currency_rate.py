...
class PurchaseForceCurrencyRate(models.TransientModel):
    _name = "purchase.force.currency.rate"
    ...
    def _get_currency_rate(self):
        ...
        if self.env.context.get('active_id', False):
            invoice = self.env['purchase.order'].browse(
    ...
    currency_rate = fields.Float('Forced currency rate',
                                 help="You can force the currency rate on "
                                      "the purchase order with this field.",
