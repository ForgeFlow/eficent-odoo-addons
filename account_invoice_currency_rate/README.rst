...
* With 'account_anglo_saxon' module is used, the price difference will be
  calculated ignoring the forced exchange rate.

Bug Tracker
===========

Bugs are tracked on `GitHub Issues
<https://github.com/OCA/95/issues>`_. In case of trouble, please
check there if your issue has already been reported. If you spotted it first,
help us smashing it by providing a detailed and welcomed `feedback
<https://github.com/OCA/
95/issues/new?body=module:%20account_invoice_currency_rate%0Aversion:%20
...
Contributors
------------
* Akretion, Benoît GUILLOT <benoit.guillot@akretion.com>
