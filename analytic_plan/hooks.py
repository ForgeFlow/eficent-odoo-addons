...
def post_init_hook(cr, pool):
    ...
    active_analytic_planning_version = env.ref(
    ...
    for aa in (
        ...
        .search([("active_analytic_planning_version", "=", False)])
    ):
        aa._write(
            {"active_analytic_planning_version": active_analytic_planning_version.id}
        )
