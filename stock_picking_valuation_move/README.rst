...
Picking Valuation Move
======================

This module adds the link from the picking to the valuation move if any.
It means to be used by administrators to detect errors in the valuation.
