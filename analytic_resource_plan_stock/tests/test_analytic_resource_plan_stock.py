...
class TestAnalyticResourcePlanStock(
    ...
    def test_res_stock(self):
        ...
        self.assertEqual(
            self.resource_plan_line.qty_available, 0.0, "Bad QTY Available"
        )
        ...
        # to put in the api depends
        self.assertEqual(
            self.resource_plan_line.virtual_available,
            1.0,
            "Bad Virtually Qty available",
        )
        self.assertEqual(self.resource_plan_line.outgoing_qty, 4.0, "Bad Outgoing Qty")
