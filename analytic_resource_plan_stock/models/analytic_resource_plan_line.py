    ...
    def _compute_quantities(self):
        for line in self:
            ...
            if stock.get(line.product_id.id, False):
                ...
                line.virtual_available = stock[line.product_id.id]["virtual_available"]
    ...
    def _compute_done_quantities(self):
        for line in self:
            ...
            if stock.get(line.product_id.id, False):
                ...
                line.outgoing_done_qty = stock[line.product_id.id]["qty_available"]
            else:
                line.outgoing_done_qty = 0.0
            line.incoming_done_qty = (
                line.qty_available - line.outgoing_qty - line.outgoing_done_qty
            )
